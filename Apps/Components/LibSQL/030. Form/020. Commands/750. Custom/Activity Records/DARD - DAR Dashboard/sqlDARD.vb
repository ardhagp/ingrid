    ...
    Public Class View
        ...
        Public Shared Sub GetDailyStatistic(databasename As String, chrt As Chart)
            Try
                ...
                V_DBR_MSSQL2008(0).Query = "select top 30 ea.employeeactivity_datetime, (select count(eac.employeeactivity_id) from dbo.doc_employeeactivity eac " &
                ...
                V_DBE_MSSQL2008.GetDataTable(databasename, V_DBR_MSSQL2008(0), "TDailyChart")
        ...
        Public Shared Sub GetYearlyStatistic(databasename As String, chrt As Chart)
            Try
                'ReDim V_DBR_MSSQL2008(4)
                V_DBR_MSSQL2008(0).Query = "select top 5 year(employeeactivity_datetime) as [employeeactivity_datetime], count(ea.employeeactivity_id) as [qty_activity] from dbo.doc_employeeactivity ea " &
                    "group by year(ea.employeeactivity_datetime) order by year(ea.employeeactivity_datetime) desc;"
                'Chrt.DataSource = _DBE_MSSQL2008.GETDATAROW(V_DBR_MSSQL2008(1).Query)
                V_DBR_MSSQL2008(0).DataGrid = Nothing
                V_DBR_MSSQL2008(0).StatusBar = Nothing
                V_DBR_MSSQL2008(0).Chart = chrt
                V_DBE_MSSQL2008.GetDataTable(databasename, V_DBR_MSSQL2008(0), "TYearlyChart")
        ...
        Public Shared Sub GetMonthlyStatistic(databasename As String, chrt As Chart)
            Try
                ...
                V_DBR_MSSQL2008(0).StatusBar = Nothing
                V_DBR_MSSQL2008(0).Chart = chrt
                V_DBE_MSSQL2008.GetDataTable(databasename, V_DBR_MSSQL2008(0), "TMonthlyChart")
