...
Namespace CMDrems
    Public Class View
        ...
        Public Shared Sub DisplayGrid(dataproperties As LibApp.Ingrid.Global.Properties, progressgrid As CMCv.UI.Control.dgn, donegrid As CMCv.UI.Control.dgn, verifiedgrid As CMCv.UI.Control.dgn, todostatusbar As CMCv.UI.Control.stt, Optional showall As Boolean = False)
            Try
                ...
                varDatabaseEngineMssql2008.GetDataTable(dataproperties.ConnectionDatabaseName, varDatabaseRequestMssql2008(0), "TToDosProgress")
