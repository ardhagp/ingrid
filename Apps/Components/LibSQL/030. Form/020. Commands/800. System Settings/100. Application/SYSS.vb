...
Namespace CMDsyss
    Public Class View
        ...
        Public Shared Function GetSettingValue(databasename As String, dbengine As LibApp.Ingrid.Global.DatabaseEngine, dbcolumn As String) As Object
            Try
    ...
    Public Class Editor
        <SupportedOSPlatform("windows")>
        Public Shared Function SaveSettings(databasename As String, dbengine As LibApp.Ingrid.Global.DatabaseEngine, profile As Integer, storage As Integer, newsticker As Integer, minphoto As Integer, minpdf As Integer, watermark As Integer, watermarktext As String, minpassword As Integer) As Boolean
            Try
                If dbengine = LibApp.Ingrid.Global.DatabaseEngine.MSSQL Then
