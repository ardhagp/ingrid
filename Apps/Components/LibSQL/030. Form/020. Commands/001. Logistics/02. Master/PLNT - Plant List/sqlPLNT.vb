...
Namespace CMDplnt
    ...
    Public Class View
        ...
        ''' <returns></returns>
        <SupportedOSPlatform("windows")>
        Public Shared Function DeleteData(databasename As String, dbengine As String, ByVal rowid As String) As Boolean
    ...
    Public Class Editor
        ...
        ''' <returns></returns>
        <SupportedOSPlatform("windows")>
        Public Shared Function IsDuplicate(databasename As String, dbengine As String, companycode As String, plantcode As String, Optional rowid As String = "") As Boolean
            rowid = "0"
