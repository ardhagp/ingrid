...
Public Class FRMphotoresizer
    ...
    Private varJPG As String = varJPG
    Private varJPEG As String = varJPEG
    ...
    Private Sub BtnLoad_Click(sender As Object, e As EventArgs)
        ...
        If OfdLoad.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            If TxtLoad.Text.Contains(varJPG) AndAlso ChkSaveAsACopy.Checked Then
                TxtSave.Text = TxtLoad.Text.Replace(varJPG, "_COMPRESSED.jpg")
            ElseIf TxtLoad.Text.Contains(varJPEG) AndAlso ChkSaveAsACopy.Checked Then
                TxtSave.Text = TxtLoad.Text.Replace(varJPEG, "_COMPRESSED.jpeg")
            Else
    ...
    <SupportedOSPlatform("windows")>
    Private Sub FRMphotoresizer_Load(sender As Object, e As EventArgs) Handles MyBase.Load
