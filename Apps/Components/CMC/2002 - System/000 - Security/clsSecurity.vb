...
Namespace Security
    Public Class Engine
        ''' <summary>
        ''' This class will be removed from project
        ''' 
        ''' </summary>
        ''' <remarks></remarks>
#Region "Class Variables"
        ...
        '        Private Shared ReadOnly IV_8 As Byte() = New Byte() {2, 63, 9, 36, 235, 174, 78, 12}
        '        Private Shared ReadOnly IV_16 As Byte() = New Byte() {15, 199, 56, 77, 244, 126, 107, 239,
        '                                              9, 10, 88, 72, 24, 202, 31, 108}
        '        Private Shared ReadOnly IV_24 As Byte() = New Byte() {37, 28, 19, 44, 25, 170, 122, 25,
        '                                              25, 57, 127, 5, 22, 1, 66, 65,
        '                                              14, 155, 224, 64, 9, 77, 18, 251}
        '        Private Shared ReadOnly IV_32 As Byte() = New Byte() {133, 206, 56, 64, 110, 158, 132, 22,
