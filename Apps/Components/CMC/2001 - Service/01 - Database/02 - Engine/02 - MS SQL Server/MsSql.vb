Namespace Database.Engine
    Public Class Mssql
        ...
        Private ReadOnly varMsSql As New Connect.MsSqlConnection
        ...
        Public Function Open(databaseproperties As LibApp.Ingrid.Global.Properties, Optional splash As System.Windows.Forms.Form = Nothing) As Boolean
            ...
            Try
                varConnection(1) = New Microsoft.Data.SqlClient.SqlConnection(varMsSql.MssqlStandard(databaseproperties.ConnectionServerAddress, databaseproperties.ConnectionServerPort, databaseproperties.ConnectionDatabaseName, databaseproperties.ConnectionUsername, databaseproperties.ConnectionPassword))
