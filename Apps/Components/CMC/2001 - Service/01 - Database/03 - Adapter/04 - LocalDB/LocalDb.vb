Namespace Database.Adapter.Localdb.Display
    ''' <summary>
    ''' This structure is used to pass parameters for displaying data from a LocalDB database in various UI controls such as DataGrid, StatusBar, Dropdown, and Chart.
    ''' </summary>
    Public Structure Request
        ''' <summary>
        ''' The SQL query string to be executed against the LocalDB database.
        ''' </summary>
...
Namespace Database.Adapter.Localdb
    ''' <summary>
    ''' This structure is used to pass parameters for executing SQL commands against a LocalDB database.
    ''' </summary>
