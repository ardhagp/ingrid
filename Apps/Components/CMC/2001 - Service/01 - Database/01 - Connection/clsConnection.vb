...
#Region "OLEDB"
        ...
        ''' <remarks></remarks>
        Function Microsoftoledbstandard(databasepath As String, username As String, password As String) As String
#End Region
...
#Region "ODBC"
        ...
        ''' <returns>String</returns>
        ''' <remarks></remarks>
        Function Microsoftodbcstandard(databasepath As String, username As String, password As String) As String
#End Region
    End Interface
...
#Region ".NET Standard"
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function Mssql2008standard(serveraddress As String, serverport As Integer, databasename As String, username As String, password As String) As String
        ...
        ''' <returns></returns>
        ''' <remarks></remarks>
        Function Mssql2008trustedconnection(serveraddress As String, databasename As String) As String
#End Region
    End Interface
