...
#Region "Menu Strip Function"
    ...
    Private Sub EventDataAddNew() Handles _MMSMenu.EventDataAddNew
        ...
        Display(_DAR_Editor, QERP.Main.ImageLibrary.EDIT_002_512_icon, "Add New Record", "Add new activity", True)
    ...
    Public Sub EventDataEdit() Handles _MMSMenu.EventDataEdit
        ...
        Else
            _DAR_Editor = New DAR_Editor
            Display(_DAR_Editor, QERP.Main.ImageLibrary.EDIT_002_512_icon, "Update Record", "update activity", True)
        End If
        mainframe.ts_status.Text = String.Empty
    End Sub
    ...
    Private Sub DgnFile_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DgnFile.CellContentClick
        ...
        Try
            If TypeOf sendergrid.Columns(e.ColumnIndex) Is DataGridViewButtonColumn AndAlso e.RowIndex >= 0 Then
                ...
                _DirTempLocation = ingrid.CHECKREQUIREDFOLDER(DirName.PDF)
...
#Region "WithEvents"
    ...
    Private Sub _MMSMenu_EventReportShow() Handles _MMSMenu.EventReportShow
        If _USERAccess.User("DAR", _USERAttrib.UID, LibSQL.Application.Access.TypeOfAccess.Report) = False Then
            Decision("You are not authorized to : Show Report", "Not Authorized", CMCv.frmDialogBox.MessageIcon.Error, CMCv.frmDialogBox.MessageTypes.OkOnly)
            Exit Sub
        End If
        _DAR_Reports = New DAR_RPTFilter
        Display(_DAR_Reports, QERP.Main.ImageLibrary.SEARCH_001_512_icon, "Report Filter", "", True,)
