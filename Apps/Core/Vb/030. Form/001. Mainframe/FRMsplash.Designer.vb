Namespace UI
    ...
    Partial Class FRMsplash
        ...
        Private Sub InitializeComponent()
            ...
            tlp_.ColumnCount = 1
            tlp_.ColumnStyles.Add(New ColumnStyle(SizeType.Percent, 100.0F))
            ...
            tlp_.Name = "tlp_"
            tlp_.RowCount = 3
            tlp_.RowStyles.Add(New RowStyle(SizeType.Absolute, 212.0F))
            tlp_.RowStyles.Add(New RowStyle(SizeType.Absolute, 38.0F))
            ...
            LblAdditional.Font = New Font("Segoe UI", 12.0F, FontStyle.Regular, GraphicsUnit.Point)
