...
Partial Class FRMeplsPosition
    ...
    Private Sub InitializeComponent()
        ...
        DataGridViewCellStyle1.BackColor = Color.FromArgb(CByte(246), CByte(232), CByte(149))
        ...
        DgnAddinPosition.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
