Namespace UI.Canvas
    ...
    Partial Class FRMvdls
        ...
        Private Sub InitializeComponent()
            ...
            DgnVendor = New CMCv.UI.Control.Dgn(components)
            ...
            ' DgnVendor
            ' 
            DataGridViewCellStyle4.BackColor = Color.FromArgb(CByte(230), CByte(222), CByte(187))
            ...
            DgnVendor.Font = New Font("Verdana", 8.0F, FontStyle.Regular, GraphicsUnit.Point)
            ...
            PerformLayout()
        End Sub
        Friend WithEvents DgnVendor As CMCv.UI.Control.Dgn
