Namespace UI
    ...
    Partial Class FRMsloc
        ...
        Private Sub InitializeComponent()
            ...
            DgnSLOC = New cmcv.ui.control.dgn(components)
            ...
            DataGridViewCellStyle4.BackColor = Color.FromArgb(CByte(211), CByte(249), CByte(100))
            ...
            DgnSLOC.Font = New Font("Verdana", 8.0F, FontStyle.Regular, GraphicsUnit.Point)
            ...
            PerformLayout()
        End Sub
        Friend WithEvents DgnSLOC As cmcv.ui.control.dgn
