...
#Region "Declaration"
        ...
        Private WithEvents Frm_dar_Reports As UI.Canvas.FRMreportsDARfilter
        ...
        Private Const varMessageViewAttachment As String = "EventToolsViewAttachment"
...
#Region "Sub Collections"
        ...
        Private Sub GetData(Optional forcerefresh As Boolean = False)
            ...
            CMDdar.View.DisplayMainGrid(varDataProperties, TxtFind, DgnDARDate, SLFStatus, SttActivity, ChkEnableDateFilter, DtpMonth, ChkEnableByFilter, CboBy, forcerefresh)
        ...
        Private Sub LoadMenu()
            ...
            If (CMDdar.View.CheckSettings(varDataProperties, "viewphototab")) Then
        ...
        Private Sub OnDgnDateChange()
            ...
            End If
            CMDdar.View.DisplaySecondGrid(varDataProperties, varCurrentDateString, DgnDARActivity, SttActivity, TxtFind, varShowAttachment, DgnPhoto, DgnFile)
        ...
        Private Sub GetRowID()
            ...
            Else
                ...
                varDataProperties.AllParameters.Remove(pCustomActivityId)
                varDataProperties.AllParameters.Add(pCustomActivityId, CLng(DgnDARActivity.CurrentRow.Cells("employeeactivity_id").Value))
            End If
        End Sub
        ...
        Private Sub LoadAttachment(ByVal istabattachmentvisible As Boolean)
            If (istabattachmentvisible) Then
                DblBuffer(DgnPhoto)
                CMDdar.View.DisplayPhotoGrid(varDataProperties, varContentID, DgnPhoto)
...
#Region "Main Form Events"
        ...
        Private Sub FRMdar_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
            If (Com_mms_Menu.Checked(varMessageViewAttachment)) Then
                CMDdar.View.SaveSettings(varDataProperties, "ViewPhotoTab", "True")
            Else
                CMDdar.View.SaveSettings(varDataProperties, "ViewPhotoTab", "False")
            End If
        End Sub
            ...
            Else
                If Not (CMDdar.View.IsLike(varDataProperties, DgnPhoto.CurrentRow.Cells("photo_id").Value.ToString, varDataProperties.EmployeeId)) Then
                    If (CMDdar.View.LikePhoto(varDataProperties, DgnPhoto.CurrentRow.Cells("photo_id").Value.ToString, varDataProperties.EmployeeId, DgnDARActivity.CurrentRow.Cells("employee_id").Value.ToString)) Then
                        UI.Canvas.FRMmainframe6.Ts_status.Text = DgnPhoto.CurrentRow.Cells("photo_employee_fullname").Value.ToString & " would like to say thank you for your appreciation."
                    Else
