...
Partial Class FRMdar
    ...
    Private Sub InitializeComponent()
        ...
        Pnl3 = New pnl(components)
        DgnDARDate = New dgn(components)
        employeeactivity_datetime = New DataGridViewTextBoxColumn()
        employeeactivity_longdate = New DataGridViewTextBoxColumn()
        Pnl4 = New pnl(components)
        TbctlStatistic = New tbctl(components)
        ...
        ChkEnableDateFilter = New chk(components)
        ChkEnableByFilter = New chk(components)
        DtpMonth = New dtp(components)
        miniToolStrip = New stt(components)
        ...
        Pnl1.SuspendLayout()
        CType(SpcDate, ComponentModel.ISupportInitialize).BeginInit()
        SpcDate.Panel1.SuspendLayout()
        SpcDate.Panel2.SuspendLayout()
        SpcDate.SuspendLayout()
        Pnl3.SuspendLayout()
        CType(DgnDARDate, ComponentModel.ISupportInitialize).BeginInit()
        Pnl4.SuspendLayout()
        TbctlStatistic.SuspendLayout()
        dailyreports.SuspendLayout()
        ...
        PnlFind.Controls.SetChildIndex(ChkEnableByFilter, 0)
        PnlFind.Controls.SetChildIndex(ChkEnableDateFilter, 0)
        PnlFind.Controls.SetChildIndex(BtnClear, 0)
        PnlFind.Controls.SetChildIndex(CboBy, 0)
        ' 
        ' BtnClear
        ' 
        ...
        ' SpcDate.Panel1
        ' 
        SpcDate.Panel1.Controls.Add(Pnl3)
        SpcDate.Panel1MinSize = 140
        ' 
        ' SpcDate.Panel2
        ' 
        ...
        DataGridViewCellStyle22.BackColor = Color.FromArgb(CByte(251), CByte(194), CByte(174))
        DgnDARDate.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle22
        ...
        DataGridViewCellStyle23.BackColor = Color.YellowGreen
        DataGridViewCellStyle23.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle23.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle23.SelectionBackColor = Color.YellowGreen
        DataGridViewCellStyle23.SelectionForeColor = Color.Black
        DataGridViewCellStyle23.WrapMode = DataGridViewTriState.True
        DgnDARDate.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle23
        DgnDARDate.ColumnHeadersHeight = 43
        DgnDARDate.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.DisableResizing
        ...
        DataGridViewCellStyle26.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle26.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle26.SelectionBackColor = Color.Yellow
        DataGridViewCellStyle26.SelectionForeColor = Color.Black
        DgnDARDate.RowHeadersDefaultCellStyle = DataGridViewCellStyle26
        ...
        ' 
        employeeactivity_datetime.AutoSizeMode = DataGridViewAutoSizeColumnMode.Fill
        employeeactivity_datetime.DataPropertyName = "employeeactivity_datetime"
        DataGridViewCellStyle24.Alignment = DataGridViewContentAlignment.MiddleLeft
        DataGridViewCellStyle24.Font = New Font("Microsoft Sans Serif", 12.75F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle24.Format = "dd MMM yy"
        DataGridViewCellStyle24.NullValue = Nothing
        employeeactivity_datetime.DefaultCellStyle = DataGridViewCellStyle24
        ...
        employeeactivity_datetime.Visible = False
        ' 
        ...
        employeeactivity_longdate.DefaultCellStyle = DataGridViewCellStyle25
        ...
        DataGridViewCellStyle27.BackColor = Color.FromArgb(CByte(237), CByte(210), CByte(119))
        DgnDARActivity.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle27
        ...
        DataGridViewCellStyle28.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle28.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle28.SelectionBackColor = Color.YellowGreen
        DataGridViewCellStyle28.SelectionForeColor = Color.Black
        DataGridViewCellStyle28.WrapMode = DataGridViewTriState.True
        DgnDARActivity.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle28
        ...
        DataGridViewCellStyle33.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        ...
        DgnDARActivity.DefaultCellStyle = DataGridViewCellStyle33
        ...
        DataGridViewCellStyle34.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle34.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle34.SelectionBackColor = Color.Yellow
        DataGridViewCellStyle34.SelectionForeColor = Color.Black
        DataGridViewCellStyle34.WrapMode = DataGridViewTriState.True
        DgnDARActivity.RowHeadersDefaultCellStyle = DataGridViewCellStyle34
        ...
        areaaffected_name.DefaultCellStyle = DataGridViewCellStyle29
        ...
        employeeactivity_time.DefaultCellStyle = DataGridViewCellStyle30
        ...
        employeeactivity_description.DefaultCellStyle = DataGridViewCellStyle31
        ...
        employee_nickname.DefaultCellStyle = DataGridViewCellStyle32
        ...
        DataGridViewCellStyle35.BackColor = Color.FromArgb(CByte(247), CByte(224), CByte(132))
        DgnPhoto.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle35
        ...
        DataGridViewCellStyle36.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle36.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle36.SelectionBackColor = Color.YellowGreen
        DataGridViewCellStyle36.SelectionForeColor = Color.Black
        DataGridViewCellStyle36.WrapMode = DataGridViewTriState.True
        DgnPhoto.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle36
        ...
        DataGridViewCellStyle38.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle38.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle38.SelectionBackColor = Color.Yellow
        DataGridViewCellStyle38.SelectionForeColor = Color.Black
        DataGridViewCellStyle38.WrapMode = DataGridViewTriState.True
        DgnPhoto.RowHeadersDefaultCellStyle = DataGridViewCellStyle38
        ...
        photo_content_size.DefaultCellStyle = DataGridViewCellStyle37
        ...
        PctbxActivityPhoto.BackgroundImage = CType(resources.GetObject("PctbxActivityPhoto.BackgroundImage"), Image)
        ...
        DataGridViewCellStyle39.BackColor = Color.FromArgb(CByte(199), CByte(214), CByte(164))
        DgnFile.AlternatingRowsDefaultCellStyle = DataGridViewCellStyle39
        ...
        DataGridViewCellStyle40.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle40.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle40.SelectionBackColor = Color.YellowGreen
        DataGridViewCellStyle40.SelectionForeColor = Color.Black
        DataGridViewCellStyle40.WrapMode = DataGridViewTriState.True
        DgnFile.ColumnHeadersDefaultCellStyle = DataGridViewCellStyle40
        ...
        DataGridViewCellStyle42.BackColor = Color.YellowGreen
        DataGridViewCellStyle42.Font = New Font("Verdana", 8F, FontStyle.Regular, GraphicsUnit.Point)
        DataGridViewCellStyle42.ForeColor = SystemColors.WindowText
        DataGridViewCellStyle42.SelectionBackColor = Color.Yellow
        DataGridViewCellStyle42.SelectionForeColor = Color.Black
        DataGridViewCellStyle42.WrapMode = DataGridViewTriState.True
        DgnFile.RowHeadersDefaultCellStyle = DataGridViewCellStyle42
        ...
        file_content_size.DefaultCellStyle = DataGridViewCellStyle41
        ...
        ' ChkEnableByFilter
        ' 
        ChkEnableByFilter.AutoSize = True
        ...
        SpcDate.Panel1.ResumeLayout(False)
        SpcDate.Panel2.ResumeLayout(False)
        CType(SpcDate, ComponentModel.ISupportInitialize).EndInit()
        SpcDate.ResumeLayout(False)
        Pnl3.ResumeLayout(False)
        CType(DgnDARDate, ComponentModel.ISupportInitialize).EndInit()
        Pnl4.ResumeLayout(False)
        TbctlStatistic.ResumeLayout(False)
        dailyreports.ResumeLayout(False)
    ...
    Friend WithEvents DtpMonth As dtp
    Friend WithEvents ChkEnableDateFilter As chk
    Friend WithEvents SpcDate As SplitContainer
    Friend WithEvents Pnl3 As pnl
    Friend WithEvents DgnDARDate As dgn
    Friend WithEvents Pnl4 As pnl
    Friend WithEvents TbctlStatistic As tbctl
    ...
    Friend WithEvents miniToolStrip As stt
    ...
    Friend WithEvents CboBy As cbo
    Friend WithEvents ChkEnableByFilter As chk
