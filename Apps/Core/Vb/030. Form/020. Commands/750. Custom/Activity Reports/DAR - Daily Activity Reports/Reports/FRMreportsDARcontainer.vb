...
Namespace UI.Canvas
    Public Class FRMreportsDARcontainer
        Public Event ReportClosed()
        Public _DS As New UI.DAR_RDS
        ...
        Public Sub New(datasetname As UI.DAR_RDS, creator As String, rcolor As Boolean, appversion As String)
